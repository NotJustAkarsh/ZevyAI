      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 z-50 h-screen w-[380px] bg-[#0f1117] border border-white/10 shadow-2xl flex flex-col"
          >
            <div className="flex items-center justify-between p-5 border-b border-white/10">
              ...
              >
                <X size={18} className=" hover:text-red-500 text-slate-300" />
              </button>
            </div>
            <div className="p-5">
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4">
              ...
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <p className="text-indigo-400 text-2xl font-bold mt-2">₹599</p>
